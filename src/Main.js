    ...
    return (
        <main>
            ...
            <section className="fifth-part">
                <figure>
                    <iframe width="660" height="371" src="https://www.youtube.com/embed/9SbnhgjeyXA" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
            ...
            <section className="seventh-part">
                <div className="green-square"></div>
                <div className="container-double-image">
                    <div className="first-image"></div>
                    <div className="second-image"></div>
                </div>
                <div className="third-image"></div>
            </section>
            <section className="eight-part">
                <p>
            ...
            <section className="nineth-part">
                <img src="https://ableton-production.imgix.net/about/poster-meet-the-makers.jpg?auto=format&dpr=2.0&fit=crop&fm=jpg&ixjsv=1.1.3&q=50&w=1160" />
            </section>
            <section className="tenth-part">
                <p>
            ...
            <section className="eleventh-part">
                <div className="purple-square"></div>
                <div className="first-image"></div>
                <div className="second-image"></div>
            </section>
            <section className="twelveth-part">
                <p>
            ...
            <section className="thirdteenth-part">
